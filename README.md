...
**Plugins (via omz):** git, sudo, history-substring-search, dirhistory, docker, docker-compose, tailscale, zsh-autosuggestions, zsh-syntax-highlighting, fzf-tab, zsh-completions
